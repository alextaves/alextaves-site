...
export default function App() {
  ...
  const [phase, setPhase] = useState('carousel') // 'carousel' | 'fading' | 'site' | 'journal' | 'fiction' | 'hum' | 'detroit' | 'detroitRemix' | 'detroitNine' | 'detroitGrid' | 'detroitBlue' | 'detroitFlood' | 'detroitBlack' | 'detroitHalves' | 'detroitFaces' | 'detroitCamo' | 'detroitOneFace' | 'detroitBlueGround' | 'detroitChunky' | 'detroitOnBlack' | 'detroitShuffle' | 'detroitRun' | 'detroitRunBlack' | 'detroitRunBlue' | 'postcards'
    ...
    const onMsg = (e) => {
      ...
      if (e.data && typeof e.data === 'object' && e.data.type === 'portalClick'
        ...
        const to = ['detroitFaces', 'detroitRemix', 'detroitNine', 'detroitGrid',
                    ...
                    'detroitCamo', 'detroitOneFace', 'detroitBlueGround', 'detroitChunky', 'detroitOnBlack', 'detroitShuffle', 'detroitRun', 'detroitRunBlack', 'detroitRunBlue'][e.data.idx]
  ...
  useEffect(() => {
    ...
    const IFRAME_PHASES = new Set(['carousel', 'fiction', 'hum', 'detroit', 'detroitRemix', 'detroitNine', 'detroitGrid', 'detroitBlue', 'detroitFlood', 'detroitBlack', 'detroitHalves', 'detroitFaces', 'detroitCamo', 'detroitOneFace', 'detroitBlueGround', 'detroitChunky', 'detroitOnBlack', 'detroitShuffle', 'detroitRun', 'detroitRunBlack', 'detroitRunBlue', 'postcards'])
